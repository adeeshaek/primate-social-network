...
2. Groups of Monkeys are represented by a container class, which keeps track of them using an array. Python arrays are arrays of references, and the array representing a group is an array of references to elements of class AgentClass. 
