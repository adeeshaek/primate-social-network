...
class TranslocationDonorControlSimulation(ControlSimulation):
		...
		if (this_agent.sex == "m"):
			if (this_agent.age > constants.ADULTHOOD_AGE['m']):
				probability_of_translocation =\
				 ...
				 control_translocation_likelihood[this_agent.age][0]
			...
			if (this_agent.age > constants.ADULTHOOD_AGE['f']):
				probability_of_translocation =\
				table_data.translocation_table.\
				control_translocation_likelihood[this_agent.age][1]
